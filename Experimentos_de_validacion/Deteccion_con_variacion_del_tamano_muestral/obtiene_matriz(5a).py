...
def extract_segments_multi(avian_files, individual_files, avian_samples=5):  # Removed human_files parameter and human_samples
    """
...
def main():
    ...
    try:
        ...
        # Using only avian samples (5) and removed human files processing
        extract_segments_multi(avian_files, individual_files, avian_samples=5)
