...
def extract_segments_multi(avian_files, human_files, individual_files, avian_samples=8, human_samples=3):  # Changed default values here
    """
...
def main():
    ...
    try:
        ...
        # Using new sample sizes (8 avian, 3 human)
        extract_segments_multi(avian_files, human_files, individual_files, avian_samples=8, human_samples=3)
